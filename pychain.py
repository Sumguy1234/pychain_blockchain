...
sender_data_input = st.text_input("Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data_input = st.text_input("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data_input = st.text_input("amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender_data_input,receiver_data_input,amount_data_input),
        creator_id=42,
